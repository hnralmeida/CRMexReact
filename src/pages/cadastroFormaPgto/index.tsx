...
const CadastroFormaPgto = () => {
    ...
    const onSubmit = (data: any) => {   //==> (values: any)
        ...
        api.post('/cadpagamento/' + authID, data, {
    ...
    return (
        <Box m="20px">
            <Header title="CADASTRAR FORMAS DE PAGAMENTO" subtitle="Cadastro de novas formas de pagamento" />
            ...
            >
                ...
                <TextField
                    ...
                    error={!!errors["codigo_formaspgto"]} // verifica se há um erro para o campo atual
                    helperText={errors["codigo_formaspgto"]?.message?.toString()} // exibe a mensagem de erro para o campo atual

                    sx={{ gridColumn: "span 2" }}
                    {...register("codigo_formaspgto", { required: true })}
                />
...
export default CadastroFormaPgto;
...
//types
import {ProdutoData} from '../../types/authentication';
...
function EditarPagina_5() {
    ...
    const [produto, setProduto] = React.useState<ProdutoData>();
    ...
    React.useEffect(() => {
        if (produto) {
          Object.keys(produto).forEach((key) => {
            setValue(key as keyof ProdutoData, produto[key as keyof ProdutoData]);
          });
        }
      },[produto, setValue]);
